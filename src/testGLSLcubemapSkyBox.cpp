...
{   glShadeModel(GL_SMOOTH);
    ...
    loadTexture("data/textures/cubemapping/cubemap_clouds/yneg.bmp",GL_TEXTURE_CUBE_MAP_NEGATIVE_Y_EXT);
    loadTexture("data/textures/cubemapping/cubemap_clouds/ypos.bmp",GL_TEXTURE_CUBE_MAP_POSITIVE_Y_EXT);
...
void drawThings()
{
    ...
    //glScaled(2,1,1);
    shader->begin();
    shader->setUniform1f("Time",frame/10);
    //glutWireSphere(1.01,50,50);
